<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Get in Touch with Office Essentials</h3>
        <p class="mt-3 text-black w-fit">We're here to help you equip your workspace for success</p>
      </div>

    ...
    <section id="hero-section" class="bg-white dark:bg-gray-900 flex-1" style="min-height: 230px;">
        <div id="hero-container" data-mf-new="true" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28" style="">
            <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7">
                <div id="hero-title-container-text" class="flex" style="">
                    <h1 id="hero-title" data-mf-new="true" class="flex-1 max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent" style="">Premium Office Supplies</h1>
                </div>
